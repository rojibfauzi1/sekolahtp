    ...
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_half"> 
          ...
          <form method="post" action="cari_pengumuman.php" style="margin-left:-20px">
              <table border="0px">
          ...
          <table>
            ...
            <?php
             $limit = 20;
            $jumlah_record = $conn->query("SELECT * from pengumuman");
            ...
            $sql = "SELECT * FROM pengumuman order by tgl_posting desc limit $start,$limit ";
            $s = $conn->query($sql);
            $no=1;
