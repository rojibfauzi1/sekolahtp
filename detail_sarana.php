      ...
      <div class="group btmspace-30" > 
        ...
        <div class="one_half"style="width:650px"> 
          ...
          <table>
            ...
            $sql = "SELECT sarana_sekolah.id_sarana,sarana_sekolah.nama_sarana,mata_pelajaran.matapelajaran,sarana_sekolah.fungsi,sarana_sekolah.jumlah,sarana_sekolah.keterangan,pengajar.nama_guru FROM sarana_sekolah 
            join pengajar_mapel on sarana_sekolah.id_sarana=pengajar_mapel.id_sarana 
            join mata_pelajaran on pengajar_mapel.id_mapel=mata_pelajaran.id_matapelajaran 
            join pengajar on pengajar_mapel.id_pengajar=pengajar.id_pengajar
            where pengajar_mapel.id_sarana = '".$_GET['id']."'
            order by sarana_sekolah.id_sarana desc limit $start, $limit";
            $s = $conn->query($sql);
            $no=1;
