        ...
        <div class="one_half"> 
          ...
          <table>
           ...
           if($_POST['submit']){
            ...
            $sql = "SELECT materi.judul,mata_pelajaran.matapelajaran,materi.file_materi FROM materi join mata_pelajaran on materi.id_matapelajaran=mata_pelajaran.id_matapelajaran Where materi.judul like '%$cari%' and mata_pelajaran.matapelajaran like '%$cari%'";
            $s = $conn->query($sql);
            $no=1;
